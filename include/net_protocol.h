 ...
 *
 */
#ifndef __CONNECTIVITY_NET_PROTOCOL_H
#define __CONNECTIVITY_NET_PROTOCOL_H
...
#define ASSERT_PACKET_SIZE(s)	static_assert(sizeof(s) == PACKET_SIZE, "Invalid struct size : " #s)
...
ASSERT_PACKET_SIZE(CodecDataPacket);
...
ASSERT_PACKET_SIZE(AVPacketPacket);
...
ASSERT_PACKET_SIZE(CursorPacket);
...
ASSERT_PACKET_SIZE(CursorPositionPacket);
...
ASSERT_PACKET_SIZE(BackchannelPacket);
...
ASSERT_PACKET_SIZE(CommandPacket);
